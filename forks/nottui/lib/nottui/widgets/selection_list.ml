...
let filterable_selection_list
  ...
  vbox
    [ filter_text_ui |> Border_box.box ?focus_attr:list_outline_focus_attr ~pad_w ~pad_h
    ; ( list_ui |> Border_box.box ?focus_attr:list_outline_focus_attr ~pad_w ~pad_h |>$ fun x ->
